...
Vn       = -625.00000        ! Pairing strength, isoscalar-like.
Vp       = -625.00000        ! Pairing strength, isoscalar-vector. 
...
protonsize =       0.0       ! Rms radius of the proton to be assumed.
                             ! If 0.0, no folding is used.
/
\end{Verbatim}
\end{minipage}
