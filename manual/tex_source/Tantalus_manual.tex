...
Estabp/n   =    0.0           ! Cutoff factors for the stabilized pairing functional of J. Erler et al., EPJA 37 (2008).
                              ! Set to zero to disable. Typical value when active = 0.3 MeV 
cuttype  =    1               ! Type of pairing cutoff to use. 
                              ! 1 = Symmetric fermi function around the fermi energy
                              !   => Use with standard zero-range pairing interactions
                              ! 2 = Fermi function                               
                              !   => Use with standard zero-range pairing interactions
                              ! 3/4: don't use 
