...
# run as:
#
#   > mpirun -n 4 python test_real_example_nonrandom_pyelpa.py
...
if __name__ == "__main__":
    ...
    with ( scalapack(b'C', 2, 2) as context
        ...
        elpa_status = 0
        scalapack._elpa_allocate_(elpa_status)

    scalapack.blacs_exit(0) # otherwise the program crashes on finishing. (see ./readmd.md)