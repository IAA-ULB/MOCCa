# All instances of pyev have been changed into pyev
...
def test_processor_layout():
    ...
    from pyev import ProcessorLayout
...
def test_distributed_matrix_from_processor_layout(na, nev, nblk):
    ...
    if use_pyelpa:
        import pyelpa as pyev
    from pyev import ProcessorLayout, DistributedMatrix
...
if __name__ == "__main__":
    the_test_you_want_to_debug = test_call_eigenvalues

    print("__main__ running", the_test_you_want_to_debug)
    the_test_you_want_to_debug(*parameter_list[0])
    print("-*# finished #*-")
# ==============================================================================
