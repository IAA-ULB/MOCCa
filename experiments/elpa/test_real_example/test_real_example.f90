...
!-------------------------------------------------------------------------------
  ...
  call pdtran(na, na, 1.d0, z, 1, 1, sc_desc, 1.d0, a, 1, 1, sc_desc) ! A = A + Z**T : this makes A symmetric (since A was first set equal to Z and Z+Z' is necessarily symmetric)
