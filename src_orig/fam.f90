module fam
  ...
  subroutine iterate_dHsp(dHsp_flat, dHspout_flat)
    ...
    if (pairingtype==0) then ! FAM
      ...
      ! - - - - - - - - -
      ! TEMPORARY HACK: the calculation of the pairing potentials as generated by Hephaestos
      !                 is of by a factor two, while the calculation of the pairing gaps
      !                 is of by a factor 1/2. As a result, mean-field calculations are correct.
      !                 In linear response calculations however
      !                   - perturbed potential calculation is correct
