...
$PARAMDECL
    ...
    logical       :: protonsize_selfconsistent=.true.
...
contains
   ...
   subroutine readparameterization(name_param, func_name) 
    ...
    &              protonsize, protonsize_selfconsistent,                      &
...
$CHECKPARAMS
  ...
  subroutine printparameterization(param_name, func_name)
    ...
    82 format ('   Included self-consistently.')
    83 format ('   Not included self-consistently.')
    ! - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -    
...
$PRINTPARAMS
    ...
    if(protonsize.ne.0.0) then
      print 81
      if(protonsize_selfconsistent) then
        print 82
      else
        print 83
      endif
