...
$PARAMDECL
    ...
    ! Parameters of the qp cutoff for quasiparticles
    real(KIND=dp) :: c_qpcut = 50.0, d_qpcut = 0.03
    !---------------------------------------------------------------------------
    ...
    ! qpsinMOI: 
    ! ---------
    !  Currently, when time-reversal is broken, quasiparticle energies can 
    !  become negative through either blocking or polarisation effects.  
    !  This is problematic for the calculation of the Belyaev moment of inertia.
    !  Currently, the strategy is to remove ALL quasiparticles with negative
    !  energy from the relevant sums. If this flag is set to true, we implement
    !  the previous strategy, removing only the blocked quasi-particle(s) from 
    !  the calculations. If the blocked qp is the only one with negative 
    !  energy, this results of course in an identical calculation.
    logical :: qpsinMOI = .false. 
    !===========================================================================
...
contains
   ...
   subroutine readparameterization(name_param, func_name) 
    ...
    &              CutType,  rotcorr_cut, rotcutwindow, rotcutmu, qpsinMOI,    &
    &              c_qpcut, d_qpcut,                                           &
    ...
    if( .not. exists) then   
        ...
        if(.not.exists) then
          ...
          inquire(exist=exists, file=toopen)
          if(.not.exists) then
              print *, 'No FORCE.param file found.'
              stop
          endif
        endif
    endif  
...
$CHECKPARAMS
  ...
  subroutine printparameterization(param_name, func_name)
   ...
   1082 format('      mu         =', 2f6.3, ' (MeV)')
    ...
    110 format('    QP-cutoff :  ACTIVE')
    111 format('      c_qpcut    =',f6.3, '(MeV^-1)')
    112 format('      d_qpcut    =',f6.3)
    ! - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -    
    ...
    &           '!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!')  
    998 format ('!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!',/&
    &           '!  Attention: qpsinMOI is True. Qps with negative energy   ',/&
    &           '!  can contribute to the Belyaev moment of inertia.'        ,/&
    &           '!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!')  
