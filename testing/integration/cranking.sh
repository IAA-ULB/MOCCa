#-------------------------------------------------------------------------------
# Perform two cranked calculations for Cr48 with SLy4 
#  - one with a fixed Jz=2
#  - one with a fixed omega_z=0.3292333881 MeV/hbar
# Both should give the same total energy of -411.090 MeV.
# - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
# This script tests:
...
exit $(( $tantalus_check_J || $check_energy_J || $tantalus_check_omega || $check_energy_omega ))
