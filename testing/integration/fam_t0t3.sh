...
fail=$(($mocca_check || $fam_check || $fam_T_check || $fam_P_check || $qfam_check || $qfam_T_check || $qfam_P_check || $check_energy || $check_strength || $check_strength_T || $check_strength_P || $check_strength_QRPA || $check_strength_QRPA_T))
