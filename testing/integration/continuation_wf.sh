#-------------------------------------------------------------------------------
# Perform a calculation writing a wavefunction file and then a second one to
# check the quality of the codes warmstarting capabilities
# - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
# This script tests:
...
# Useage
# ------
#   bash continuation_wf.sh [EXESUFFIX] [PARAM]
#
...
if (($fail == 0)) ; then
    echo -e "test continuation_wf :\033[1;32m success \033[0m"
else
    echo -e "test continuation_wf :\033[1;31m failed ! 1st : $tantalus_check, 2nd : $tantalus_check_continuation, E : $check_E, convergence : $c_a $c_b \033[0m"
fi
