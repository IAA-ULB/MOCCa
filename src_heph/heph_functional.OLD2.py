...
#   *) One term per line, separations by commas
#   *) First entry is the name of the term, following the naming scheme
#   *) second entry is the isospin-scalar coupling constant, defined in 
#      function of quantities known by Tantalus.
#   *) third entry is the isospin-vector coupling constant, similary defined.
...
#    E_D_I_I_D_I_I    , +3.0/8.0*t0+0*t0*x0+0*t3+0*t3*x3 , -1.0/8.0*t0-0.25*t0*x0+0*t3+0*t3*x3 
#
