...
def initdensities():
    ...
    densities     = [['rho','vecs'], ['tau','TN2LO'], ['vecj', 'Jmunu']]
    leftoperators = [Identity, Nabla, Identity]
    rightoperators= [Identity, Nabla, Nabla   ]
    currents      = [0,0,1,1]
    deriv_needed  = [1,0,0,0]
    lapla_needed  = [1,0,0,0]
...
#        exit
    ...
    Den_template_2 = Template(tab+'$SIGN $LEFTWF(i,1,1,$LIND,wave) * $RIGHTWF(i,1,1,$RIND,wave)')
