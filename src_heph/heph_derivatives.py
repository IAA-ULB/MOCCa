...
def ProcessDerivatives(fname, src, target, so, dry_run=False):

   """
   This function generates the derivative-related parts of the FORTRAN
   source code based on the symmetry options that were chosen for the
   calculation.

   The following variables are set in the FORTRAN file:
